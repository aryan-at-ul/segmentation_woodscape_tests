...
from model import UNET, model_def_dunet, model_vig, model_unet,model_swinunet, model_trans
from utils import (
    load_checkpoint,
    save_checkpoint,
    get_loaders,
...
from trans_losses import get_segmentation_loss
...
class TrainEpoch(Epoch):
    ...
    def batch_update(self, x, y):
        ...
        outputs, add_loss = self.model.forward(x)
...
model_dunet =  model_trans#model_swinunet#model_vig 
...
loss = get_segmentation_loss()#DiceLossC()
